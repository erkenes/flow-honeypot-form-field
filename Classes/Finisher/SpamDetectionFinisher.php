...
namespace Erk\Flow\HoneypotFormField\Finisher;

/*
 * This file is part of the Erk.Flow.HoneypotFormField package.
 *
 * (c) Daniel Lienert 2018 & Enes Erk 2022
 *
...
class SpamDetectionFinisher extends AbstractFinisher
{
    ...
    protected function findHoneypotFields(): array
    {
        ...
        foreach ($renderables as $renderable) {
            if ($renderable->getType() === 'Erk.Flow.HoneypotFormField:HoneypotField') {
